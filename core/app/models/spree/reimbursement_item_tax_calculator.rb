module Spree
  ...
  #    Spree::Reimbursement.reimbursement_item_tax_calculator = calculator_object
  # where `calculator_object` is an object that responds to "call" and accepts an array of reimbursement items

  class ReimbursementItemTaxCalculator

    class << self

      def call(reimbursement_items)
