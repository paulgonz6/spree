...
module Spree
  class Order < ActiveRecord::Base
    ...
    def associate_user!(user, override_email = true)
      ...
      attrs_to_set[:ship_address_attributes] = (user.ship_address.try(:attributes) || {}).except('id', 'updated_at', 'created_at')
      attrs_to_set[:bill_address_attributes] = (user.bill_address.try(:attributes) || {}).except('id', 'updated_at', 'created_at')
