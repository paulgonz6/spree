class RecreateSpreeReturnAuthorizations < ActiveRecord::Migration
  def up
    ...
    Spree::Adjustment.update_all({source_type: 'Spree::LegacyReturnAuthorization'}, {source_type: 'Spree::ReturnAuthorization'})
  ...
  def down
    ...
    Spree::Adjustment.update_all({source_type: 'Spree::ReturnAuthorization'}, {source_type: 'Spree::LegacyReturnAuthorization'})
