...
describe Spree::OrderContents do
  ...
  context "#add" do
    ...
    it "should create stock location associations if provided" do
      ...
      line_item_stock_locations.count.should == 2
      line_item_stock_locations.map(&:quantity).should == [1, 2]
      line_item_stock_locations.map(&:stock_location_id).should == [stock_location.id, stock_location_2.id]
    end
