# FORK_STATUS
# Waiting on a pull request to be merged into Spree master
# https://github.com/spree/spree/pull/4308
...
describe "Rabl Cache" do
  ...
  it "doesn't create a cache key collision for models with different rabl templates" do
    ...
    # Turn on caching in spec/dummy/config/environments/test.rb to expose this issue
    if Dummy::Application.config.action_controller.perform_caching
