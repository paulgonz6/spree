module Spree
  module Api
    class StockItemsController < Spree::Api::BaseController
      before_filter :edit_stock_location, only: [:create]
      before_filter :read_stock_location, only: [:index, :show]
      ...
      def read_stock_location
        stock_location_by_ability(:read)
      end

      def edit_stock_location
        stock_location_by_ability(:update)
      end

      def stock_location_by_ability(ability)
